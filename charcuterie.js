...
const brieMap = new Map([
    ...
    ["spreadInfo", "Honey is a simple, sweet complement to the top of a brie. For a savoury flavor profile, a caramelized onion jam adds a salty-but-sour taste that pairs beautifully with a baked Brie!"],
  ...
  const cheddarMap = new Map([
    ...
    ["fruitInfo", "A crisp, sweet apple like a Gala or Honeycrisp is the classic cheddar-fruit pairing. Pears offer a similar sweet balance to cheddar. BONUS: For a brighter pairing, try pineapple or tart cherries!"],
    ["compCheese1", "Brie"],
    ["compCheese2", "Gouda"],
